...
const groups=[
  ['OPERATIONS',[['conversations','Conversations'],['archives','Archives'],['engage/traffic','Engage / Traffic'],['case-management','Case Management']]],
...
const iconMap={conversations:'◫',archives:'▱','engage/traffic':'◉','case-management':'◇',knowledge:'▤','ai-rules':'⌘',responses:'≡','menu-penting':'★','bekal-bot':'◆','canned-responses':'#','telegram-cta':'↗','telegram-settings':'✦','website-profile':'◎','ai-settings':'⚙',learning:'↻',logs:'☷','system-health':'♥',security:'⌾'};
